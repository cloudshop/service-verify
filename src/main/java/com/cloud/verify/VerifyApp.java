package com.cloud.verify;

import com.cloud.verify.client.OAuth2InterceptedFeignConfiguration;
import com.cloud.verify.config.ApplicationProperties;
import com.cloud.verify.config.DefaultProfileUtil;
...
public class VerifyApp {
    ...
    public VerifyApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(VerifyApp.class);
